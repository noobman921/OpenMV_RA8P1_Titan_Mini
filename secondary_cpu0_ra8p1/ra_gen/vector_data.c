...
/* Do not build these data structures if no interrupts are currently allocated because IAR will have build errors. */
        ...
        BSP_DONT_REMOVE const fsp_vector_t g_vector_table[BSP_ICU_VECTOR_NUM_ENTRIES] BSP_PLACE_IN_SECTION(BSP_SECTION_APPLICATION_VECTORS) =
        {
            ...
            [23] = mipi_csi_pm_isr, /* MIPICSI PM (Power Management interrupt) */
            [24] = mipi_csi_gst_isr, /* MIPICSI GST (Generic Short Packet interrupt) */
            [25] = dmac_int_isr, /* DMAC0 INT (DMAC0 transfer end) */
            [26] = sci_b_uart_rxi_isr, /* SCI1 RXI (Receive data full) */
            [27] = sci_b_uart_txi_isr, /* SCI1 TXI (Transmit data empty) */
            [28] = sci_b_uart_tei_isr, /* SCI1 TEI (Transmit end) */
            [29] = sci_b_uart_eri_isr, /* SCI1 ERI (Receive error) */
            [30] = rtc_carry_isr, /* RTC CARRY (Carry interrupt) */
            [31] = spi_b_rxi_isr, /* SPI1 RXI (Receive buffer full) */
            [32] = spi_b_txi_isr, /* SPI1 TXI (Transmit buffer empty) */
            [33] = spi_b_tei_isr, /* SPI1 TEI (Transmission complete event) */
            [34] = spi_b_eri_isr, /* SPI1 ERI (Error) */
        ...
        const bsp_interrupt_event_t g_interrupt_event_link_select[BSP_ICU_VECTOR_NUM_ENTRIES] =
        {
            ...
            [23] = BSP_PRV_VECT_ENUM(EVENT_MIPICSI_PM,GROUP7), /* MIPICSI PM (Power Management interrupt) */
            [24] = BSP_PRV_VECT_ENUM(EVENT_MIPICSI_GST,GROUP0), /* MIPICSI GST (Generic Short Packet interrupt) */
            [25] = BSP_PRV_VECT_ENUM(EVENT_DMAC0_INT,GROUP1), /* DMAC0 INT (DMAC0 transfer end) */
            [26] = BSP_PRV_VECT_ENUM(EVENT_SCI1_RXI,GROUP2), /* SCI1 RXI (Receive data full) */
            [27] = BSP_PRV_VECT_ENUM(EVENT_SCI1_TXI,GROUP3), /* SCI1 TXI (Transmit data empty) */
            [28] = BSP_PRV_VECT_ENUM(EVENT_SCI1_TEI,GROUP4), /* SCI1 TEI (Transmit end) */
            [29] = BSP_PRV_VECT_ENUM(EVENT_SCI1_ERI,GROUP5), /* SCI1 ERI (Receive error) */
            [30] = BSP_PRV_VECT_ENUM(EVENT_RTC_CARRY,GROUP6), /* RTC CARRY (Carry interrupt) */
            [31] = BSP_PRV_VECT_ENUM(EVENT_SPI1_RXI,GROUP7), /* SPI1 RXI (Receive buffer full) */
            [32] = BSP_PRV_VECT_ENUM(EVENT_SPI1_TXI,FIXED), /* SPI1 TXI (Transmit buffer empty) */
            [33] = BSP_PRV_VECT_ENUM(EVENT_SPI1_TEI,FIXED), /* SPI1 TEI (Transmission complete event) */
            [34] = BSP_PRV_VECT_ENUM(EVENT_SPI1_ERI,FIXED), /* SPI1 ERI (Error) */
